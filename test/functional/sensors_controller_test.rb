...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { content: @sensor.content, description: @sensor.description, name: @sensor.name }
    end
  ...
  test "should update sensor" do
    put :update, id: @sensor, sensor: { content: @sensor.content, description: @sensor.description, name: @sensor.name }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
